...
public class EmailUtility {
	...
	public static void getPieChart() throws TranscoderException, IOException {
		...
		String mailText = "<table cellspacing=\"0\" cellpadding=\"0\" border=\"1\" style=\"table-layout:fixed;font-size:13px;font-family:arial,sans,sans-serif;border-collapse:collapse;border:1px solid rgb(204,204,204)\">"
				...
				+"<tr style=\"height:21px\"><td style=\"padding:2px 3px;vertical-align:bottom;background-color:rgb(153,153,153)\" align=\"center\"><span style=\"font-family:arial;font-size:small\"><b>Site</b></span><br></td><td  style=\"padding:2px 3px;vertical-align:bottom;background-color:rgb(153,153,153)\" align=\"center\">"
						+ site
						+ "</td></tr>"
